...
class AdaptiveCC : public CCC {
  ...
  // For ADC
  double recordCycle,recordEmpty,oldRttStanding,simiLast;
  ...
  std::deque<std::pair<double, double>> operating_Qd_array;
  std::deque<std::pair<double, double>> operating_rtt_array;
  std::deque<std::pair<double, double>> operating_cwnd_array;
  double sum_operating_Qd;
  double sum_operating_rtt;
  double sum_operating_cwnd;
  int count_operating_Qd;
  //std::deque<std::pair<double, double>> operating_Qd_array;
  //double steady_T;
  double steady_fm;
  double steady_T;
  ...
  double operating_rtt_avg;
  double operating_cwnd_avg;

  double smooth_pkt_loss_interval;

  bool compete_mode,iniProc;
...
public:
  ...
  AdaptiveCC(double delta)
    : delta(delta),
      ...
      compete_fm(0.0),
      P_min(100000.0),
      operating_rtt_avg(0.0),
      operating_cwnd_avg(0.0),
