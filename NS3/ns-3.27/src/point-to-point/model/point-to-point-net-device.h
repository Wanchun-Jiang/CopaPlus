...
public:
  ...
  void Setlossrate(double value);//^_^
...
private:
   ...
   */
  DataRate       m_bps;
  Time m_interval; //DataRate change interval
  Ptr<UniformRandomVariable> m_RandomRate; //m_RandomRate
  //bool isRandomChange,isLossChange;
