...
private:
  ...
  Time m_interval; //delay change interval 
  uint32_t baseRTT;
  bool isDelayChange,islossChange,isBwChange,poissonDelay; //wujia 2020 0513
  Ptr<UniformRandomVariable> m_RandomDelay; //RandomDelay
  /**
