...
protected:
  double m_pacing_rate;

public:
  void SetPacingRate(double pacingRate);
...
protected:
  EventId 			m_pacing_event;
  std::queue<tcp_pacing_struct> m_pacing_packets;
private:
  void PacePackets();
...
protected:
  ...
  bool    m_pdccEnabled;       //!< PDCC option enabled ^_^
